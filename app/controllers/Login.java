...
import models.FacebookUserObject;
import models.User;
import models.UserFacebookInfo;
...
public class Login extends Controller {
	...
	private static void login(String accessToken) {
		...
		if (!session.contains("userId")
				|| (fbObject != null && fbObject.id != null && fbObject.id
						.equals(""))) {
			// もしユーザーのFacebook情報が見つからなかったらアカウントを作成する
			UserFacebookInfo facebookInfo = UserFacebookInfo
					.findByFacebookId(fbObject.id);
